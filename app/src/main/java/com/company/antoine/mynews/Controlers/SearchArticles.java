...
public class SearchArticles extends AppCompatActivity implements DatePickerDialog.OnDateSetListener, Validator.ValidationListener{
    ...
    private String mSection = "news_desk:";
